...
export const LOGO_OVERRIDES = {
  // Premier League — Sofascore CDN (direct img, no auth, no CORS)
  ...
  // Eredivisie — fixed IDs (Ajax was wrongly 2655=Strasbourg, PSV was wrongly 2672=Bayern)
...
/* ═══ PLAYER FACE IDs (Sofascore) ═══ */
export const PLAYER_IDS = {
  // Bayern / Bundesliga
  "Harry Kane":         36956,
  "Serhou Guirassy":    342229,
  // Saudi
  "Riyad Mahrez":       84798,
  "Karim Benzema":      3781,
  "Cristiano Ronaldo":  14981,
  // Argentina
  "Ángel Di María":     50056,
  // La Liga
  "Iñaki Williams":     818671,
  "Nico Williams":      948738,
  "Antoine Griezmann":  85975,
  "Julián Álvarez":     979606,
  "Raphinha Belloli":   349990,
  "Lamine Yamal":       1157765,
  "Vinícius Jr":        889569,
  "Kylian Mbappé":      1057814,
  "Takefusa Kubo":      null,
  // MLS
  "Lionel Messi":       24116,
  "Luis Suárez":        2456,
  ...
  // Premier League
  "Bukayo Saka":        517603,
  "Viktor Gyökeres":    null,
  "Mohamed Salah":      80654,
  "Florian Wirtz":      948513,
  "Erling Haaland":     1109028,
  "Bruno Fernandes":    236088,
  // Serie A
  "Rafael Leão":        849591,
  "Luka Modrić":        5846,
  "Kevin De Bruyne":    70958,
  "Paulo Dybala":       105288
};
...
export function renderLogo(wrapEl, flagEl, team) {
  ...
  if (url) {
    ...
    img.loading = 'lazy';
    img.onerror = () => {
      wrapEl.innerHTML = `<span class="team-logo-fallback" style="font-size:2rem;line-height:1">${team.f||'🌐'}</span>`;
    };
...
export async function fetchTeamsData() {
  try {
    ...
    if (!res.ok) throw new Error("Teams data not found");
